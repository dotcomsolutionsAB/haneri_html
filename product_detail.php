                        ...
                        <div class="col-lg-8 pb-1">
                            <div class="single-product-custom-block">
                                <div class="porto-block">
                                    ...
                                    <h5 class="porto-heading d-inline-block">100% Money Back
                                        Guarantee</h5>
                            ...
                            <div class="product-single-details mb-1">
                                <h1 class="product-title">Haneri AirElite AEW1</h1>
                                ...
                                <div class="product-desc">
                                    <p>
                                        The Haneri AirElite AEW1 exhaust fan is a compact 4-inch device designed for powerful performance and lasting reliability. Equipped with a well-engineered, robust motor, it provides strong suction and efficient airflow, effectively eliminating odors, smoke, and humidity to keep your environment fresh and healthy. Made from durable materials with premium finishes, it ensures long-lasting use. Its sleek and elegant design seamlessly fits into any room, making the AirElite AEW1100 an ideal combination of performance, style, and reliability for modern homes.
                                        ...
                                        <ul class="config-size-list">
                                            <li>
                                                <a href="javascript:;"
                                                    ...
                                                    <img src="assets/images/products/zoom/product-1.jpg" width="30"
                                                        height="30" alt="filter-img" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="javascript:;"
                                                    class="d-flex align-items-center justify-content-center p-0">
                                                    <img src="assets/images/products/zoom/product-2.jpg" width="30"
                                                        height="30" alt="filter-img" />
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="javascript:;"
                                                    class="d-flex align-items-center justify-content-center p-0">
                                                    <img src="assets/images/products/zoom/product-3.jpg" width="30"
                                                        height="30" alt="filter-img" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="javascript:;"
                                                    class="d-flex align-items-center justify-content-center p-0"> <img
                                                        src="assets/images/products/zoom/product-4.jpg" width="30"
                                                        height="30" alt="filter-img" />
                                                </a>
                                            </li>
                                        </ul>
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="product-tab-reviews" data-toggle="tab"
                                            ...
                                            aria-controls="product-reviews-content" aria-selected="false">Warranty</a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="product-desc-content" role="tabpanel"
                                        ...
                                        <div class="product-desc-content">
                                            ...
                                            <img src="assets/images/products/single/product-img.jpg" alt="image desc"
                                                class="float-right" />
