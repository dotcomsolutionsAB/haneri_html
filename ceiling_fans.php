...
<head>
    ...
    <title>Haneri - Ceiling Fans</title>
            ...
            <div class="container pt-1">
                <div class="row">
                    ...
                    <div class="col-lg-12 main-content">
                            ...
                            <div class="row">
                                <div class="col-md-4 product-single-gallery">
                                        ...
                                        <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                            <div class="product-item">
                                                <img class="product-single-image"
                                                    ...
                                                    data-zoom-image="images/place.jpg"
                                    ...
                                    <div class="prod-thumbnail owl-dots">
                                        <div class="owl-dot">
                                            <img src="images/place.jpg" width="110"
                                ...
                                <div class="col-md-7 product-single-details">
                                    <h1 class="product-title">FENGSHUI</h1>

                                    <!-- product_change section -->
                                    ...
                                    <ul class="single-info-list">
                                        ...
                                        <li>
                                            CATEGORIES:
                                            <strong><a href="#" class="product-category">FANS</a></strong>,
                                            <strong><a href="#" class="product-category">CEILING FANS</a></strong>
                                        </li>
                                        ...
                                        <div class="product-single-filter flex-column align-items-start">
                                            ...
                                            <ul class="config-size-list config-color-list config-filter-list">
                                                <li class=""><a href="javascript:;" class="filter-color border-0"
                                                        style="background-color: rgb(32, 92, 124);"></a></li>
                                                <li class=""><a href="javascript:;"
                                                        class="filter-color border-0 initial disabled"
                                                        style="background-color: rgb(100, 125, 161);"></a></li>
                                                <li class=""><a href="javascript:;" class="filter-color border-0"
                                                        style="background-color: rgb(208, 165, 84);"></a></li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="product-single-share mb-2">
                                        ...
                                        <!-- <a href="wishlist.php" class="btn-icon-wish add-wishlist"
                        ...
                        <?php include("inc_files/product/tab_section.php"); ?>
