<div class="sidebar dark:bg-coal-600 bg-light border-e border-e-gray-200 dark:border-e-coal-100 fixed top-0 bottom-0 z-20 hidden lg:flex flex-col items-stretch shrink-0"
    ...
    <div class="sidebar-header hidden lg:flex items-center relative justify-between px-3 lg:px-6 shrink-0"
        ...
        <div class="sidebar-header hidden lg:flex items-center relative justify-between px-3 lg:px-6 shrink-0"
            id="sidebar_header">
            <!-- Single Logo for Light & Dark Mode -->
            <a href="index.php">
                <img class="default-logo min-h-[22px] max-w-none" src="uploads/Haneri_Logo.png" alt="Haneri Logo" />
                <!-- If you want a smaller variant when sidebar is collapsed,
                    you can still include the small-logo (just hide it unless collapsed) -->
                <img class="small-logo min-h-[22px] max-w-none hidden" src="uploads/Haneri_Logo.png" alt="Haneri Small Logo" />
            </a>
