<div class="container text-left">
    <h1 class="font4 text-uppercase about_section">OUR BRANDS</h1>
</div><!-- End .container -->
<div class="container">
