    ...
    <div class="container">
        <div class="row row-bg" id="vision">
            ...
            <div class="col-xl-7 col-lg-6">
                ...
                <ul>
                    <li><strong>High Air Delivery:</strong>
                    ...
                    <li><strong>Precision Manufacturing:</strong>
                    ...
                    <li><strong>Silent Performance:</strong>
