...
<div class="brand-row-container">
    <div class="brand-row reverse">
        <div class="brand-content">
            <h2>Key Features of S.C.A.N Technology</h2>
            <div class="points">
                ...
                <h4>Comprehensive Fan Control:</h4>
                <ul>
                ...
                <h4>Advanced Timer Functionality:</h4>
                <ul>
                ...
                <h4>Reliable Radio Frequency Control:</h4>
                <ul>
...
<div class="brand-row-container">
    <div class="brand-row">
        <div class="brand-content">
            ...
            <div class="points">
                <h4>Radio Frequency (RF) Innovation:</h4>
                <ul>
                ...
                <h4>Integrated Microcontroller System:</h4>
                <ul>
                ...
                <h4>Multi-Mode Control Logic:</h4>
                <ul>
...
<div class="brand-row-container">
    <div class="brand-row">
        <div class="brand-content">
            <h2>Why Choose HANERI S.C.A.N Technology?</h2>
            <p>
