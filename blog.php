	...
	<div class="blog_section container">
        ...
        <section id="blog2">
            ...
            <div class="image-gallery">
                ...
                <div class="gallery-container">
                    <img src="image1.jpg" alt="BLDC Fan Image 1" class="gallery-image">
                    <img src="image2.jpg" alt="BLDC Fan Image 2" class="gallery-image">
                    <img src="image3.jpg" alt="BLDC Fan Image 3" class="gallery-image">
                    <!-- Add more images as needed -->
                </div>
            </div>
        ...
        <section id="blog3">
            ...
            <div class="image-gallery">
                <h3>Image Gallery</h3>
                <div class="gallery-container">
                    <img src="image1.jpg" alt="Haneri Fan Image 1" class="gallery-image">
                    <img src="image2.jpg" alt="Haneri Fan Image 2" class="gallery-image">
                    <img src="image3.jpg" alt="Haneri Fan Image 3" class="gallery-image">
                    <!-- Add more images as needed -->
                </div>
            </div>
